        ...
        >
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Experience the same level of excellence in healthcare KPO services. 
              HIPAA-compliant, secure, and backed by 25+ years of industry expertise.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-8 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                Schedule Free Consultation
              </button>
              <button className="border-2 border-blue-200 text-blue-600 px-8 py-3 rounded-xl font-semibold hover:bg-blue-50 transition-colors">
