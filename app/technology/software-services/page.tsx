...
import { Code, CheckCircle, Layers, Shield, Zap, ArrowRight, Database, Globe, Award, TrendingUp , ChevronDown} from 'lucide-react'
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                  Frequently Asked <span className="bg-gradient-to-r from-orange-600 to-orange-600 bg-clip-text text-transparent">Questions</span>
                </h2>
              </div>
              <div className="space-y-4">
